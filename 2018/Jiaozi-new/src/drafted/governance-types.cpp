...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "OIOCoinNetwork") type = OIOCoinNetwork;
    if(strType == "OIOCoinNetworkVariable") type = OIOCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == OIOCoinNetwork) s = "OIOCoinNetwork";
    if(type == OIOCoinNetworkVariable) s = "OIOCoinNetworkVariable";
