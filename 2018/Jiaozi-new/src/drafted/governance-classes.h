 ...
 *
 *   // network
 *   COIOCoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.OIOCoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class COIOCoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    COIOCoinNetwork(UniValue objIn)
    {
...
// // can be under: OIOCoinNetwork
// //   -- signature requirements : Key1(User)
// class COIOCoinNetworkVariable : public CGovernanceObject
// {
// private:
