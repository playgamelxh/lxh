...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // OIOCoin: 1 day
        consensus.nPowTargetSpacing = 1 * 60; // OIOCoin: 2.5 minutes
        ...
        startNewChain = false;
        consensus.masternodeCount = 500000*COIN;

        genesis = CreateGenesisBlock( 1509937200, 0, 0x1e0ffff0, 1, 50 * COIN);
        if(startNewChain == true) { MineGenesis(genesis, consensus.powLimit, true); }

        consensus.hashGenesisBlock = genesis.GetHash();

        if(!startNewChain) {
            assert(consensus.hashGenesisBlock == uint256S("0xaccdf67973e47cc980919b49f754e18af2f8f61369619a99a8bbc4123915b994"));
            assert(genesis.hashMerkleRoot == uint256S("0xe0028eb9648db56b1ac77cf090b99048a8007e2bb64b68f092c03c7f56a662c7"));
        }

        vSeeds.push_back(CDNSSeedData("node.oiocoin.org", "node.oiocoin.org"));
        //vSeeds.push_back(CDNSSeedData("47.94.236.114", "47.94.236.114"));

        consensus.nForkHeight = 280111;

        // OIOCoin addresses start with 'P'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,43);
        // OIOCoin script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // OIOCoin private keys start with '7' or 'P'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,204);
        // OIOCoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x02)(0xFE)(0x52)(0xF8).convert_to_container<std::vector<unsigned char> >();
        // OIOCoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x02)(0xFE)(0x52)(0xCC).convert_to_container<std::vector<unsigned char> >();

        // OIOCoin BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        checkpointData = (CCheckpointData) {
            ...
            (   0, uint256S("0xaccdf67973e47cc980919b49f754e18af2f8f61369619a99a8bbc4123915b994")),
            1509937200, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // OIOCoin: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // OIOCoin: 2.5 minutes
        consensus.nPowMaxAdjustDown = 48; // 32% adjustment down
        consensus.nPowMaxAdjustUp = 32; // 16% adjustment up
        consensus.nUpdateDiffAlgoHeight = 0; // Algorithm fork block
        assert(maxUint/UintToArith256(consensus.powLimit) >= consensus.nPowAveragingWindow);
        ...
        // Testnet OIOCoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet OIOCoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet OIOCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet OIOCoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet OIOCoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CRegTestParams() {
        ...
        // Regtest OIOCoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest OIOCoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest OIOCoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest OIOCoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest OIOCoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
   }
};
