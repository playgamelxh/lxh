...
//
// The Masternode Class. For managing the PrivatePay process. It contains the input of the 100000 OIOC, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 100000 OIOC - checking if valid masternode)
