...
void CPrivatePayServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv)
{
    ...
    if(fLiteMode) return; // ignore all OIOCoin related functionality
...
/*
    ...
    allow endless transaction that would bloat OIOCoin and make it unusable. To
    stop these kinds of attacks 1 in 10 successful transactions are charged. This
    adds up to a cost of 0.001 OIOC per transaction on average.
*/
...
void ThreadCheckPrivatePayServer()
{
    ...
    RenameThread("OIOCoin-ps-server");
