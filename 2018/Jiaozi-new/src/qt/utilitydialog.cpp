    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("OIOCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About OIOCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  OIOCoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the OIOCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 OIOC, 0.1 OIOC, 1 OIOC and 10 OIOC -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://OIOCoinpay.atlassian.net/wiki/display/DOC/PrivatePay\">https://OIOCoinpay.atlassian.net/wiki/display/DOC/PrivatePay</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("OIOCoin Core is shutting down...") + "<br /><br />" +
