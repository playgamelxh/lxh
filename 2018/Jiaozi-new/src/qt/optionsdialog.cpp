    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("OIOC-light"), QVariant("light"));
    ui->theme->addItem(QString("OIOC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("OIOC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("OIOC-traditional"), QVariant("trad"));
