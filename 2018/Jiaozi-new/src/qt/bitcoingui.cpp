    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("OIOCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a OIOCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and OIOCoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About OIOCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about OIOCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for OIOCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your OIOCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified OIOCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a OIOCoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the OIOCoin Core help message to get a list with possible OIOCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("OIOCoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QUrl AuthorUrl("http://101.200.41.213/");
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to OIOCoin network", "", count));
}
...
{
    QString strTitle = tr("OIOCoin Core"); // default title
