...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("OIOCoin Core OIOCoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  OIOCoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded OIOCoin transaction") + "\n" +
              "  OIOCoin-tx [options] -create [commands]   " + _("Create hex-encoded OIOCoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded OIOCoin transaction
