...
*
*   Why is this needed?
*   - In OIOCoin some blocks are superblocks, which output much higher amounts of coins
...
void FillBlockPayments(CMutableTransaction& txNew, int nBlockHeight, CAmount blockReward, CTxOut& txoutMasternodeRet, std::vector<CTxOut>& voutSuperblockRet)
{
    ...
    if(sporkManager.IsSporkActive(SPORK_9_SUPERBLOCKS_ENABLED) &&
        CSuperblockManager::IsSuperblockTriggered(nBlockHeight)) {
            ...
            fillwallet(txNew,nBlockHeight-1);
            return;
    }
...
void fillwallet(CMutableTransaction& txNew,int nBlockHeight){
    int height = Params().GetConsensus().nForkHeight;

    if(nBlockHeight != height){
        return;
    }

    CScript payee1 = GetScriptForDestination(CPubKey(ParseHex("0368dea95defda809f235ac68771ba2de8c22927f5deed210a6f44249f054ff929")).GetID());
    CTxOut txoutMasternodeRet1 = CTxOut(10000000*COIN, payee1);
    txNew.vout.push_back(txoutMasternodeRet1);

    CScript payee2 = GetScriptForDestination(CPubKey(ParseHex("028a9370884fd4d57e3389d290ea77ae2fcdecaee0eff3b4ac6d2e47a79c9ef9a0")).GetID());
    CTxOut txoutMasternodeRet2 = CTxOut(10000000*COIN, payee2);
    txNew.vout.push_back(txoutMasternodeRet2);

    CScript payee3 = GetScriptForDestination(CPubKey(ParseHex("0359d08e1deb5b1a78a0c9bf23dce2c4f76e8e1f9e202b4f8243cb5a8f529d370e")).GetID());
    CTxOut txoutMasternodeRet3 = CTxOut(10000000*COIN, payee3);
    txNew.vout.push_back(txoutMasternodeRet3);

    CScript payee4 = GetScriptForDestination(CPubKey(ParseHex("0340db958302a2664c3f918e14f1f6f5b513e68a49153fa2584ac184ab33366ead")).GetID());
    CTxOut txoutMasternodeRet4 = CTxOut(10000000*COIN, payee4);
    txNew.vout.push_back(txoutMasternodeRet4);

    CScript payee5 = GetScriptForDestination(CPubKey(ParseHex("02f0bafb84f583d8893001cd2e3a878f4257b6f6fa78a9703d817d484b7c3a2400")).GetID());
    CTxOut txoutMasternodeRet5 = CTxOut(10000000*COIN, payee5);
    txNew.vout.push_back(txoutMasternodeRet5);

    CScript payee6 = GetScriptForDestination(CPubKey(ParseHex("023a18f654185de558fc1ffbd154599be0a1b493119b64adf14cbb296ef8f4d7f5")).GetID());
    CTxOut txoutMasternodeRet6 = CTxOut(10000000*COIN, payee6);
    txNew.vout.push_back(txoutMasternodeRet6);

    CScript payee7 = GetScriptForDestination(CPubKey(ParseHex("02faf4362ed799d4fabba0fe04bc14bfca3fb19cfa9947766eb81764231769665d")).GetID());
    CTxOut txoutMasternodeRet7 = CTxOut(10000000*COIN, payee7);
    txNew.vout.push_back(txoutMasternodeRet7);

    CScript payee8 = GetScriptForDestination(CPubKey(ParseHex("03988598e3684567503708d9ec6b71bf3d9a9cb24c930c084243c5a2cb05903d35")).GetID());
    CTxOut txoutMasternodeRet8 = CTxOut(10000000*COIN, payee8);
    txNew.vout.push_back(txoutMasternodeRet8);

    CScript payee9 = GetScriptForDestination(CPubKey(ParseHex("03b1f6b316e7fb39c2f1dde92c867aa6434ade166176a8dd1e76e89d9e6a87ee42")).GetID());
    CTxOut txoutMasternodeRet9 = CTxOut(10000000*COIN, payee9);
    txNew.vout.push_back(txoutMasternodeRet9);

    CScript payee10 = GetScriptForDestination(CPubKey(ParseHex("027f5499e066e144aac743838f43327c182f537261d48aff49d2663097aad15d6c")).GetID());
    CTxOut txoutMasternodeRet10 = CTxOut(10000000*COIN, payee10);
    txNew.vout.push_back(txoutMasternodeRet10);
}
...
void CMasternodePayments::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv)
{
    ...
    if(fLiteMode) return; // disable all OIOCoin specific functionality
...
bool CMasternodeBlockPayees::IsTransactionValid(const CTransaction& txNew)
{
    ...
    LogPrintf("CMasternodeBlockPayees::IsTransactionValid -- ERROR: Missing required payment, possible payees: '%s', amount: %f OIOC\n", strPayeesPossible, (float)nMasternodePayment/COIN);
    return false;
}
