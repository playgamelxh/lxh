...
#define BOOST_TEST_MODULE OIOCoin Test Suite

#include "test_OIOCoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_OIOCoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
