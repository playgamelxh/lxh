...
class CurlMulti_Core {
	...
	private function curlInit($url = null) {
		...
		//$opt [CURLOPT_USERAGENT] = 'iEnterprise/2.1.2 CFNetwork/711.1.16 Darwin/14.0.0';
		//$opt [CURLOPT_USERAGENT] = 'Apache-HttpClient/UNAVAILABLE (java 1.4)';
		//$opt [CURLOPT_USERAGENT] = 'Dalvik/1.6.0 (Linux; U; Android 4.1.2; GT-P5100 Build/JZO54K)';
